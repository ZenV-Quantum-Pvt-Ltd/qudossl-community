...
#    define MLKEM_PLATFORM "Windows"
#    include <intrin.h>
#    include <windows.h>
#elif defined(__APPLE__) && defined(__MACH__)
#    define MLKEM_PLATFORM "macOS"
#    include <sys/sysctl.h>
#    include <unistd.h>
#elif defined(__linux__)
#    define MLKEM_PLATFORM "Linux"
#    include <sys/auxv.h>
#    include <unistd.h>
#elif defined(__FreeBSD__)
#    define MLKEM_PLATFORM "FreeBSD"
#    include <unistd.h>
#elif defined(__OpenBSD__)
#    define MLKEM_PLATFORM "OpenBSD"
#    include <unistd.h>
#else
#    define MLKEM_PLATFORM "Unknown"
#endif

#if defined(__x86_64__) || defined(_M_X64) || defined(_M_AMD64)
#    define MLKEM_ARCH        "x86_64"
#    define MLKEM_ARCH_X86_64 1
#elif defined(__aarch64__) || defined(_M_ARM64)
#    define MLKEM_ARCH       "aarch64"
#    define MLKEM_ARCH_ARM64 1
#elif defined(__riscv) && (__riscv_xlen == 64)
#    define MLKEM_ARCH         "riscv64"
#    define MLKEM_ARCH_RISCV64 1
#elif defined(__arm__) || defined(_M_ARM)
#    define MLKEM_ARCH       "arm"
#    define MLKEM_ARCH_ARM32 1
#else
#    define MLKEM_ARCH "unknown"
#endif

QUDO_KEM_API const char *QUDO_KEM_get_platform(void)
{
    return MLKEM_PLATFORM;
}
...
#ifdef MLKEM_USE_AVX2
        if (QUDO_KEM_has_avx2()) {
...
#ifdef MLKEM_USE_NEON
        if (QUDO_KEM_has_neon()) {
...
{
    printf("QUDO KEM Library Information:\n");
    printf("  Version: %s\n", QUDO_KEM_get_version());
    printf("  Platform: %s\n", QUDO_KEM_get_platform());
    printf("  Architecture: %s\n", QUDO_KEM_get_architecture());
    printf("  CPU Cores: %d\n", QUDO_KEM_get_cpu_count());
    printf("  Features: %s\n", QUDO_KEM_get_features());
    printf("  AVX2 Support: %s\n", QUDO_KEM_has_avx2() ? "Yes" : "No");
    printf("  NEON Support: %s\n", QUDO_KEM_has_neon() ? "Yes" : "No");
}
