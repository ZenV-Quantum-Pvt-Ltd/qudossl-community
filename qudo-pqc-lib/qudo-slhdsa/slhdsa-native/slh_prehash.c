...
/* shared formatting routine for alg 23 and alg 25.
   Valid values for ph (case-sensitive): "SHA2-256", "SHA2-384", "SHA2-512",
   "SHA2-224", "SHA2-512/224", "SHA2-512/256", "SHA3-224", "SHA3-256",
   "SHA3-384", "SHA3-512", "SHAKE-128", "SHAKE-256".
   Returns 0 for unrecognized ph or NULL ph. */
