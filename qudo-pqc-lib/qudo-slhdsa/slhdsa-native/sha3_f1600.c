...
#if (defined(__x86_64__) || defined(__x86_64) || defined(_M_X64)) && !defined(SLH_NO_ASM)
/* Assembly-optimized version from OpenSSL for x86-64 */
extern void KeccakF1600(uint64_t x[25]);
...
#endif /* x86-64 assembly vs portable C */
