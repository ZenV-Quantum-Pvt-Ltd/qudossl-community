...
/* Secure zeroization: prevents compiler from optimizing away key cleanup.
   FIPS 140-3 ISO/IEC 19790: sensitive data must be zeroized on function exit. */
static SLH_INLINE void slh_cleanse(void *ptr, size_t len)
{
